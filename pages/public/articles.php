            ...
            <section class="container py-5">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        ...
                        <h1 class="h4 fw-bold m-0">Project Articles</h1>
                        <p class="text-muted m-0">Latest updates and news from ongoing projects.</p>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm mb-4" id="articles-section">
                    <div class="card-body">
                        ...
                        <?php if ($articles_result && $articles_result->num_rows > 0): ?>
                            ...
                            ?>
                            <!-- Hero Article (First) -->
                            <div class="news-hero mb-3" style="cursor: pointer;" onclick="window.location.href='/QTrace-Website/article?id=<?= $article['article_ID'] ?>';">
                                <div class="thumb">
                            ...
                            <?php else: ?>
                                ...
                                <div class="news-card" style="cursor: pointer;" onclick="window.location.href='/QTrace-Website/article?id=<?= $article['article_ID'] ?>';">
                                    <div class="thumb">
                                        <?php if (!empty($article['article_photo_url'])): ?>
                                            <img alt="<?= htmlspecialchars($article['ProjectDetails_Title']) ?>" src="<?= htmlspecialchars($article['article_photo_url']) ?>" />
                                        <?php else: ?>
